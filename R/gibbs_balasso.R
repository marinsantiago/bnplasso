# ------------------------------------------------------------------------------
# Gibbs sampler the for the Bayesian **adaptive** Lasso
# ------------------------------------------------------------------------------

gibbs_baLasso <- function(X, y, a, b, intercept,
                          variance.prior.type,
  ...
  lambda2 <- abs(rgamma(p, shape = a, rate = b)) + 1e-8
