...
The R package `bnplasso` (developer's version) implements the [Nonparametric Bayesian Lasso](https://doi.org/10.1080/10618600.2025.2572327) as described in Marin et al. (2026).
...
`bnplasso` folder in the supplementary materials to Marin et al. (2026) via `devtools`:
...
Source code and data to reproduce the results from Marin et al. (2026) are available at [https://github.com/marinsantiago/bnplasso-examples](https://github.com/marinsantiago/bnplasso-examples).
